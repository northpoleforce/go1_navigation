...
rm -rf /unilidar_sdk/unitree_lidar_ros/build /unilidar_sdk/unitree_lidar_ros/devel;\
rm -rf /unilidar_sdk/unitree_lidar_ros/catkin_point_lio_unilidar/build /unilidar_sdk/unitree_lidar_ros/catkin_point_lio_unilidar/devel;\
/opt/ros/noetic/bin/catkin_make -C /unilidar_sdk/unitree_lidar_ros;\
