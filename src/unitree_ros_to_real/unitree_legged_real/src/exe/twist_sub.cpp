...
void cmdVelCallback(const geometry_msgs::Twist::ConstPtr &msg)
{
    ...
    printf("state_x_vel = %f\n", high_state_ros.velocity[0]);
    printf("state_y_vel = %f\n", high_state_ros.velocity[1]);
    printf("state_yaw_vel = %f\n", high_state_ros.yawSpeed);
    printf("imu_roll = %f\n", high_state_ros.imu.rpy[0]);
    printf("imu_pitch = %f\n", high_state_ros.imu.rpy[1]);
    printf("imu_yaw = %f\n", high_state_ros.imu.rpy[2]);
